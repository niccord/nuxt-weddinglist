<template>
    <div class="body-font text-orange-darker bg-orange-lightest" style="font-size: 1.25em">
        <!-- Magic starts here -->
        <div name="container" class="container m-0 p-0 w-screen h-screen max-w-full">
            ...
            <div name="content" class="container max-w-md mx-auto my-4">
                <p class="subtitle-font mt-4 text-3xl">Ceremony</p>
                <p class="leading-normal">The ceremony will take place ...</p>
                <p class="leading-normal">Some other info</p>
            </div>
        </div>
        <!-- ./End of Magic -->
    </div>
